...
import {StyleSheet, Text, View,NativeAppEventEmitter,ImageBackground,  ScrollView} from 'react-native';
...
let HTML = `
<script type="text/javascript" src="http://161.97.122.128:8080/Mobilekyc.html"></script>
<div id="KYCWidget"></div>
<meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0">
<script type="text/javascript">
    new KYC({ width: "100%", height: "100%", mode: 1, lang: "en" });
</script>
`;
      ...
      return (
        ...
        <View style={{flex: 1}}>
          ...
          <WebView
                ...
                source={{uri:'http://161.97.122.128:8080/Mobilekyc.html'}}
