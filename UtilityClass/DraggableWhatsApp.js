...
export default class DraggableWhatsApp extends Component {
  static propTypes = {
          ...
          <TouchableWithoutFeedback
            ...
            ref={ref => {
              ...
              let props = {
                order: 33,
                title: '                    WhatsApp',
                titleTextColor:Platform.OS == 'ios' ? '#000000' : 'black',
                titleTextAlignment:'right',
                titleTextSize: 25,
                description: 'Tap here to send whatsApp message.',
                descriptionTextColor:Platform.OS == 'ios' ? '#000000' : 'black',
                descriptionTextAlignment:'right',
                descriptionTextSize: 18,
                outerCircleColor: GLOBALS.COLOR.YELLOW,
            ...
            <Image
              ...
              source={require('../Images/whatsAppNew.png')}
            />
          </TouchableWithoutFeedback>
        </Animated.View>
      </PanGestureHandler>
...
const styles = StyleSheet.create({
  box: {
    ...
    left: Window.width - 50 - CIRCLE_RADIUS,
