  ...
  render() {
    return (
      <View>
        ...
        {GLOBALS.ProductHeader.MARQUE_BOTTOM != null && GLOBALS.ProductHeader.MARQUE_BOTTOM != " " && GLOBALS.ProductHeader.MARQUE_BOTTOM != "" ? (
          // <View style={[
          //     {backgroundColor: GLOBALS.COLOR.BLUE, flexDirection: 'row',borderTopColor:GLOBALS.COLOR.DARKGRAY,borderTopWidth:0.6},
          // ]}>
          ...
          <LinearGradient
            ...
            key={this.state.key}
            style={{ backgroundColor: GLOBALS.COLOR.BLUE, flexDirection: 'row', borderColor: GLOBALS.COLOR.BORDER_COLOR, borderWidth: 1 }}>
            <AutoScrolling
              style={[
              ...
              <Text style={[{ color: GLOBALS.COLOR.BLACK, textAlign: 'center', fontWeight: '700' }]}>
                {GLOBALS.ProductHeader.MARQUE_BOTTOM}
              </Text>
            </AutoScrolling>
          </LinearGradient>
        ) : null}
